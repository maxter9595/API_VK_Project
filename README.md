...
В этом случае мы просим его зайти по ссылке веб-приложения PyVkontakte (ID приложения - 51849067). После перехода он копирует токен (access_token) из ссылки новой страницы и вводит его в поле ввода input (т.е. справа от надписи "Введите access_token:").
